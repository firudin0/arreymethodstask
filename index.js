...
//   let little = results.filter(order => order.order.freight < 1);

// little.

// forEach(order => {
//   console.log(`Order ID: ${order.order.id}, Freight: $${order.order.freight}`);
// });
...
// let alici = "ERNSH";
// let ernsharr = results.filter(order => order.order.customerId === customerID);
// let ernshasd = ernsharr.length;

// console.log(`ERNSHn ${ernshasd}  siparişi var.`);
// let


// //3) employeeİd- görə sortlayın (a;indira bilmedim)
...
// results.sort((a, b) => b.order.employeeId - a.order.employeeId);
